    ...
    class PromoteServiceConfig {
        ...
        companion object {
            ...
            fun fromMap(map: Map<*, *>?): PromoteServiceConfig {
                ...
                map?.let { m ->
                    cfg.foreground = m["foreground"] as? Boolean ?: false
                    cfg.title = m["title"] as? String ?: cfg.title
                    cfg.subTitle = m["subTitle"] as? String ?: cfg.subTitle
                    cfg.description = m["description"] as? String ?: cfg.description
                    cfg.showWhen = m["showWhen"] as? Boolean ?: cfg.showWhen
                }
                return cfg
            }
            ...
            fun fromString(str: String = "{}"): PromoteServiceConfig {
                ...
                try {
                    ...
                    cfg.foreground = json.optBoolean("foreground", false)
                    cfg.title = json.optString("title", cfg.title)
                    cfg.subTitle = if (json.isNull("subTitle")) null else json.optString("subTitle")
                    cfg.description = json.optString("description", cfg.description)
                    cfg.showWhen = json.optBoolean("showWhen", false)
                } catch (e: Exception) {
                    Log.e(TAG, "Error parsing PromoteServiceConfig from string: $e")
                }
                return cfg
            }
